{ lib, buildPythonPackage, fetchFromGitHub, flask, stem, pyqt5, pycrypto, pysocks, gnome3, pytest, httpauth, requests, tor, obfs4 }:
...
buildPythonPackage {
  ...
  propagatedBuildInputs = [ flask stem pyqt5 pycrypto pysocks gnome3.nautilus httpauth requests ];
